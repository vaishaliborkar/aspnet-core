...
namespace AppliedTech.TaskApp
{
    ...
    public class TaskAppWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public TaskAppWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TaskAppWebCoreModule).GetAssembly());
        }
    }
}
