...
namespace AppliedTech.TaskApp.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        private readonly TaskAppDbContext _context;

        public HostRoleAndUserCreator(TaskAppDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new TaskAppAuthorizationProvider())
