...
using Owin;
using Abp.Owin;
using AppliedTech.TaskApp.Owin;
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
           ...
           .AddJsonFormatters();
            ...
            {
                options.SwaggerDoc("v1", new Info { Title = "TaskApp API", Version = "v1" });
            ...
            return services.AddAbp<TaskAppWebHostModule>(
        ...
        {
            app.Properties["host.AppName"] = "TaskApp";
